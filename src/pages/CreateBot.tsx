...
const CreateBot = () => {
  ...
  return (
    <div className="container mx-auto min-h-screen py-8 px-4 md:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="hidden lg:block lg:w-5/12 bg-gray-100 dark:bg-gray-800 p-8 rounded-lg border border-gray-200 dark:border-gray-700">
